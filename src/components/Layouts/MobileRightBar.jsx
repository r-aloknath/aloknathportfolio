...
export default function MobileRightBar() {
    ...
    return (
        <div className={`fixed right-0 top-0 h-[100vh] w-[100vw] bg-[#ffffff21] mobile-sidebar z-[11] ${isOpen ? 'open' : ''}  visible md:hidden`}>
            <div className='h-[100vh] w-60 bg-[#222525] float-right'>
