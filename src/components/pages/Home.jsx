    ...
    <>
      <div className='bg-[#212526] flex flex-col mt-5 mb-5 px-8 py-4 rounded-md border-2 border-[#2a2e2e]'>
        ...
        <div className="contact mt-10 mb-5 grid grid-cols-12">
          <p className='text-xl md:text-2xl text-white col-span-12 md:col-span-6 mb-3 md:mb-0 text-center md:text-left'><i className="fa-regular fa-envelope text-[#56b887]"></i><a href="mailto:aloknath.ar@gmail.com" className='decoration-none ms-3'>aloknath.ar@gmail.com</a></p>
          <p className='text-xl md:text-2xl md:ms-5 text-white  col-span-12 md:col-span-6 text-center md:text-left'><i className="fa-solid fa-phone text-[#56b887] me-3"></i>+91-7749927175</p>
        </div>
      ...
      <div className="stats w-[100%] grid grid-cols-12 bg-[#212526] mt-5 mb-5 px-8 py-8 rounded-md border-2 border-[#2a2e2e]">
        <div className="col-span-6 md:col-span-3 mb-3 md:mb-0 text-center md:text-left">
      ...
      <div className="experties grid grid-cols-12 bg-[#212526] mt-5 mb-5 px-8 py-8 rounded-md border-2 border-[#2a2e2e]">
        <div className="col-span-6 md:col-span-3 flex flex-col items-center md:items-start mb-5">
          <i className="fa-brands fa-angular text-[#56b887] text-6xl md:text-7xl"></i>
          <p className='text-[#8b9f9f] text-sm md:text-lg mt-5'>ANGULR</p>
        </div>

        <div className="col-span-6 md:col-span-3 flex flex-col items-center  md:items-start mb-5">
          <i className="fa-brands fa-react text-[#56b887]  text-6xl md:text-7xl"></i>
          <p className='text-[#8b9f9f] text-sm md:text-lg mt-5'>REACT/<br />REACT NATIVE</p>
        </div>

        <div className="col-span-6 md:col-span-3 flex flex-col items-center  md:items-start mb-5">
          <img src={nextJsLogo} alt="" className='h-14 md:h-20' />
          <p className='text-[#8b9f9f] text-sm md:text-lg mt-5'>NEXT.js</p>
        </div>

        <div className="col-span-6 md:col-span-3 flex flex-col items-center  md:items-start mb-5">
          <i className="fa-brands fa-node text-[#56b887]  text-6xl md:text-7xl"></i>
          <p className='text-[#8b9f9f] text-sm md:text-lg mt-5'>NODE JS</p>
        </div>

        <div className="col-span-6 md:col-span-3 flex flex-col items-center  md:items-start mb-5">
          <i className="fa-brands fa-laravel text-[#56b887]  text-6xl md:text-7xl"></i>
